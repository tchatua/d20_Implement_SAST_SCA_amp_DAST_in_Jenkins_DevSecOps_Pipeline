...
# Changing the jenkins port to 8081
...
# Refreshing the group just to reflect  the latest changing
sudo newgrp docker
...
# JQ library installation on my jenkins beacuse, I will nee this library to implement my DevSecOps Pipeline
